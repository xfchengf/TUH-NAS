...
- The Hoouston2018 dataset can be obtained at the URL: https://machinelearning.ee.uh.edu/2018-ieee-grss-data-fusion-challenge-fusion-of-multispectral-lidar-and-hyperspectral-data/
...
- Then, you should set the path of sample assignment files e,g("Houston2018_dist_per_train-30.0_val-10.0.h5") in the config files.
